/*
  ...
  - You are about to drop the column `customer_number` on the `customer` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "customer_customer_number_key";

-- AlterTable
ALTER TABLE "customer" DROP COLUMN "customer_number",
ADD COLUMN     "customer_id_number" TEXT NOT NULL;
